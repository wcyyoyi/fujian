...
const UI_SWITCH_CONTROL_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef(() => BaSwitch),
    multi: true
};
...
// See more detail: https://github.com/yuyang041060120/angular2-ui-switch
export class BaSwitch implements ControlValueAccessor {
