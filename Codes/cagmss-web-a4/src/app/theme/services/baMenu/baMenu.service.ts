...
export class BaMenuService {
  ...
  protected _prepareItem(object:any):any {
    if (!object.skip) {
      ...
      object.pathMatch = object.pathMatch  || 'full'; //prefix
  ...
  protected _selectItem(object:any):any {
    // if(object.route.path=='words/cgfc_pdf'){
    //   alert(object.route.paths.join('/').replace('/',''));
    //   alert(this._router.url);
    // }

    object.selected = this._router.isActive(this._router.createUrlTree([object.route.paths.join('/')]), object.pathMatch === 'prefix');//full
    return object;
  }
}
