  ...
  constructor() {
    ...
    this.conf = {
      ...
      colors: {
        ...
        alertLevel: {
          blue: this.meteoAlertColors.blue,
          yellow: this.meteoAlertColors.yellow,
          orange: this.meteoAlertColors.orange,
          red: this.meteoAlertColors.red
        },
