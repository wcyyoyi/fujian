...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'forms', loadChildren: 'app/pages/forms/forms.module#FormModule', canActivate: [AuthGuard] },
      ...
      { path: 'quality', loadChildren: 'app/pages/quality/quality.module#QualityModule', canActivate: [AuthGuard] },
