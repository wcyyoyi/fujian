...
export class CropDictService extends ApiService {
    ...
    addCropToStation(data) {
        return this.http.post(this.data_url + '/mang/cropstat/batch', data, this.jwt())
            .toPromise()
            .then(res => {
                if (res.status == 200) {
                    return res.json();
    ...
    deleteCrop(code: string) {
        ...
        return this.http.request(new Request({
            ...
            url: this.data_url + '/agme/crops/' + code,
    ...
    getDevInfoByCropCodeDevCode(cropCode: string, devCode: string) {
        let url = this.data_url + '/agme/devs/cropCode/' + cropCode + '/devCode/' + devCode;
    ...
    deleteDev(obj: any) {
        return this.http.post(this.data_url + '/agme/devs/delete', obj, this.jwt())
            .toPromise()
            .then(res => {
                if (res.status == 200) {
                    return res.json();
    ...
    getExpEleListByArea(code: string, level: number) {
        return this.http.get(this.data_url + '/agme/exps/v01000/' + code + '/level/' + level, this.jwt()).map((response: Response) => response.json());
    }
    ...
    getExpEleByIdxCode(idxCode: string) {
        return this.http.get(this.data_url + '/agme/exps/cIdxcode/' + idxCode, this.jwt()).toPromise()
            .then((response: Response) => response.json());
    }
    ...
    deleteExpEle(id: string) {
        ...
        return this.http.request(new Request({
            method: RequestMethod.Delete,
            url: this.data_url + '/agme/exps/' + id,
            headers: this.jwt().headers
        }))
    }
    ...
    deleteIdxEle(id: string) {
        ...
        return this.http.request(new Request({
            method: RequestMethod.Delete,
            url: this.data_url + '/agme/idxs/' + id,
            headers: this.jwt().headers
        }))
    }
